...
authRoute.post('/sign-in', validate('json', signInSchema), authController.signIn)
authRoute.post('/sign-out', authMiddleware, authController.signOut)
authRoute.get('/me', authMiddleware, authController.me)
authRoute.post('/rotate-access-token', authMiddleware, authController.rotateAccessToken)
